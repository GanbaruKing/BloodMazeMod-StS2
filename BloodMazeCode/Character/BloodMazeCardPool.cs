...
public class BloodMazeCardPool : CustomCardPoolModel
{
    public override string Title => BloodMaze.CharacterId; //This is not a display name.
    ...
    {
        //This will attempt to load BloodMaze/images/cards/frame.png
