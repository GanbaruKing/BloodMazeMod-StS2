...
- **画像加工パイプライン** — 生成画像のタッチや色味の調整を加えて立ち絵・カードアートに仕上げる
...
カードアートやキャラクターの立ち絵は、Midjourney と DALL·E 3 で生成した画像をベースに、
厚塗り感を出すタッチの調整、色味やコントラストの補正、主題を引き立てる強調などを加えて、
目指す方向に合わせて加工・編集して仕上げています。
